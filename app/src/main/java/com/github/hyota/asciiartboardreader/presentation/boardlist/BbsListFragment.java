...
public class BbsListFragment extends Fragment {
    ...
    public interface OnBoardSelectListener {
        // TODO: Update argument type and name
        void onListFragmentInteraction(DummyItem item);
    }

    public static BbsListFragment newInstance(int columnCount) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new BbsRecyclerViewAdapter(DummyContent.ITEMS, listener));
        }
        return view;
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnBoardSelectListener) {
            listener = (OnBoardSelectListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnBoardSelectListener");
        }
    }
