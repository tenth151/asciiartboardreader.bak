...
import com.github.hyota.asciiartboardreader.presentation.boardlist.BbsListFragment.OnBoardSelectListener;
 ...
 * specified {@link OnBoardSelectListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class BbsRecyclerViewAdapter extends RecyclerView.Adapter<BbsRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final BbsListFragment.OnBoardSelectListener mListener;

    public BbsRecyclerViewAdapter(List<DummyItem> items, BbsListFragment.OnBoardSelectListener listener) {
        mValues = items;
        mListener = listener;
    }
