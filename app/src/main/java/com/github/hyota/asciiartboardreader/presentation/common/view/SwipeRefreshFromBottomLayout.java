...
public class SwipeRefreshFromBottomLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeRefreshFromBottomLayout.class.getSimpleName();
    ...
    /**
     * Set a callback to override {@link SwipeRefreshFromBottomLayout#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link SwipeRefreshFromBottomLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwipeRefreshFromBottomLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull SwipeRefreshFromBottomLayout parent, @Nullable View child);
    }
